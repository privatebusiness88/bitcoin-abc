...
def _Minutely_conform(source: str, target: str) -> bool:
    ...
    tnum = second_NUMBERS[target]
    return snum % 3 == tnum % 3

def _Hourly_conform(source: str, target: str) -> bool:
    snum = Minute_NUMBERS[source]
    tnum = Minute_NUMBERS[target]
    return snum % 3 == tnum % 3


def _Daily_conform(source: str, target: str) -> bool:
    snum = DAY_NUMBERS[source]
    tnum = DAY_NUMBERS[target]
    return snum % 3 == tnum % 3

def _months_conform(source: str, target: str) -> bool:
    snum = DAY_NUMBERS[source]
    tnum = DAY_NUMBERS[target]
    return snum % 3 == tnum % 3
