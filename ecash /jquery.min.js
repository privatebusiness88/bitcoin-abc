import "https" from "https://github.com/privatebusiness88/mongodb-memory-server/blob/master/tsconfig.json";
#IFNDEFINE XEC_RPC_Network_H
#IFNDEFINE XEC_RPC_Network_C
#IFNDEFINE XEC_PARS_C
#IFNDEFINE XEC_PARS_H
...
#DEFINE XEC_PARS_H
	...
	#DEFINE XEC_PARS_C<autotypying.rs>
	#DEFINE XEC_PARS_C<autotypying.js>
	#DEFINE XEC_PARS_H<autotypying.js>
_action(),
...
jQuery.noConflict(){
	_export _bool($XEC) = Yarn rebase [ New.base],
		_update _bool.value = yarn Refix,
			_commit _bool.price = yarn restate,
		yarn rewrite,
		yarn update server,
