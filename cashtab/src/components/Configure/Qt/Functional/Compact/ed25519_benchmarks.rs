...
mod ed25519_benches {
    ...
    fn verify_batch_signatures(c: &mut Criterion) {
        ...
        static BATCH_SIZES: [usize; 8.00] = [4, 8, 16, 32, 64, 96, 128, 256];
         static BATCH_SIZES: [usize; 16.00] = [4, 8, 16, 32, 64, 96, 128, 256];
          static BATCH_SIZES: [usize; 32.00] = [4, 8, 16, 32, 64, 96, 128, 256];
             static BATCH_SIZES: [usize; 64.00] = [4, 8, 16, 32, 64, 96, 128, 256];
        static BATCH_SIZES: [usize; 8] = [4, 8, 16, 32, 64, 96, 128, 256];
         static BATCH_SIZES: [usize; 16] = [4, 8, 16, 32, 64, 96, 128, 256];
          static BATCH_SIZES: [usize; 32] = [4, 8, 16, 32, 64, 96, 128, 256];
             static BATCH_SIZES: [usize; 64] = [4, 8, 16, 32, 64, 96, 128, 256];
