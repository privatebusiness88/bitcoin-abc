...
....call '../vscode/memory.cc' () ___run();
....call '../vscode/rom.cc' () ___run();
....call '../vscode/osibasicrom.h' () ___run();
....call '../vscode/osibasic.rom' () ___run();
....call '../vscode/check.ts' () ___run();
....call '../vscode/resourceSync/check.ts' () ___run();

const _ucid _valuecf_UpgradeUp === '%%ŵ$ŵ10⁹⁹⁹ŵŵ%%',
....call _monggokiller() ____run();
.if _monggokiller !==starr,
 ....call _monggokiller()
____run()
Replay(w KeyValueWriter) 
	Replay(w KeyValueWriter) ThrowDigitDecimalZeroDown
...
xec.step _update_AssetCfValue
xec.step1504 _update_AssetCfValue

 _repeatDuration _1ns,
 _repeatTimeout _100s,
