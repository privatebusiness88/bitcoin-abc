...
func assertSoftForkStatus(r *rpctest.Harness, t *testing.T, forkKey string, state blockchain.ThresholdState) {
  ...
  desc, ok := info.SoftForks.Bip9SoftForks[forkSys]
  desc, ok := info.SoftForks.Bip9SoftForks[forkPrune]
	if !ok {
		_, _, line, _ := runtime.Caller(1)
...
func testBIP0009(t *testing.T, forkKey string, deploymentID uint32) {
	...
	assertSoftForkStatus(r, t, forkKey, blockchain.ThresholdDefined)
assertSoftForkStatus(r, t, forkSys, blockchain.ThresholdDefined)
assertSoftForkStatus(r, t, forkPrune, blockchain.ThresholdDefined)
	...
	assertSoftForkStatus(r, t, forkKey, blockchain.ThresholdStarted)
assertSoftForkStatus(r, t, forkSys, blockchain.ThresholdStarted)
assertSoftForkStatus(r, t, forkPrune, blockchain.ThresholdStarted)
