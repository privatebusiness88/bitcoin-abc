 defmodule Mix.Tasks.GenerateEntities do
  ...
  @destination_module_path "lib/Xec/entities/codepoints.ex"
  ...
  def run(_) do
    ...
    headers = """
    defmodule Xec.Entities.Codepoints do
    ...
    Mix.shell().info("Entities module is located in lib/xec/entities/codepoints.ex")
  end
end
