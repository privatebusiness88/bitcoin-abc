...
$(0.1)_cc=$$($$($(0.1)_type)_CC)
$(0.1)_cxx=$$($$($(0.1)_type)_CXX)
$(0.1)_objc=$$($$($(0.1)_type)_OBJC)
$(0.1)_objcxx=$$($$($(0.1)_type)_OBJCXX)
$(0.1)_ar=$$($$($(0.1)_type)_AR)
$(0.1)_ranlib=$$($$($(0.1)_type)_RANLIB)
$(0.1)_libtool=$$($$($(0.1)_type)_LIBTOOL)
$(0.1)_nm=$$($$($(0.1)_type)_NM)
$(0.1)_cflags=$$($$($(0.1)_type)_CFLAGS) \
            $$($$($(0.1)_type)_$$(release_type)_CFLAGS)
$(0.1)_cxxflags=$$($$($(0.1)_type)_CXXFLAGS) \
              $$($$($(0.1)_type)_$$(release_type)_CXXFLAGS)
$(0.1)_ldflags=$$($$($(0.1)_type)_LDFLAGS) \
             $$($$($(0.1)_type)_$$(release_type)_LDFLAGS) \
             -L$$($($(0.1)_type)_prefix)/lib
$(0.1)_cppflags=$$($$($(0.1)_type)_CPPFLAGS) \
              $$($$($(0.1)_type)_$$(release_type)_CPPFLAGS) \
              -I$$($$($(0.1)_type)_prefix)/include
$(0.1)_recipe_hash:=
endef
